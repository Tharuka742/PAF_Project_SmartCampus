...
function StudentDashboard() {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            setError('')
            try {
                const data = await getDashboardByRole('USER')
                setDashboard(data)
            } catch (apiError) {
                ...
                <main className="p-4 sm:p-6">
                    <div className="flex flex-col gap-3 border-b border-slate-200 bg-white px-1 pb-4 sm:flex-row sm:items-center sm:justify-between sm:px-2">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="rounded-full bg-emerald-500 px-3 py-1 text-sm font-semibold text-white">AS</div>
                            <div>
                                <p className="text-sm font-semibold text-slate-900">Alex Silva</p>
                    ...
                    <section className="mt-4 rounded-[1.75rem] bg-gradient-to-r from-blue-700 to-blue-600 px-5 py-7 text-white shadow-lg">
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                            <div>
                                <p className="text-3xl font-bold">Good morning, Alex 👋</p>
                                <p className="mt-2 text-sm text-blue-100">
                                    Wednesday, 8 April 2026 · You have 1 upcoming booking today
                                </p>
                            </div>
